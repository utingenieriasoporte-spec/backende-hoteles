...
const inventarioBodegaModel = require("../models/inventarioBodegaModel");
...
async function listarInventarioPorBodega(idBodega) {
  const inventarioRaw = await inventarioBodegaModel.obtenerInventarioPorBodega(
    idBodega
  );
...
async function obtenerEntradasPorBodega(idBodega) {
  const inventarioRaw = await entradasModel.obtenerEntradasPorIdBodega(
    idBodega
  );
